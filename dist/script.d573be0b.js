...
var xp = document.querySelector(".experience");
var education = document.querySelector(".education");
var skills = document.querySelector(".skills");
var interests = document.querySelector(".interests");
var aboutBtn = document.querySelector(".aboutBtn");
var xpBtn = document.querySelector(".xpBtn");
var educationBtn = document.querySelector(".educationBtn");
var skillsBtn = document.querySelector(".skillsBtn");
var interestsBtn = document.querySelector(".interestsBtn");
var burger = document.querySelector(".burger");
var dropDown = document.querySelector(".list");

var scrollPage = function scrollPage(btn, element) {
